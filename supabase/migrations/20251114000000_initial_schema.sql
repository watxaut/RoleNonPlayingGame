...
CREATE TABLE IF NOT EXISTS characters (
    ...
    -- Aggregate statistics (for leaderboards and profiles)
    total_kills INTEGER DEFAULT 0,
    total_deaths INTEGER DEFAULT 0,
    total_quests_completed INTEGER DEFAULT 0,
    total_distance_traveled BIGINT DEFAULT 0,
...
-- Activity logs table
-- NOTE: Deferred for now - using aggregate stats on characters table instead
-- If detailed activity history is needed later, uncomment and implement:
--
